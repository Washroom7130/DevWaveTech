...
export default function DeleteCommentUI() {
    ...
    const comment_id = searchParam.get('comment_id')
    ...
    return(
        ...
        <div className="container-fluid">
          ...
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">Xóa Đánh Giá</h1>
          </div>
          ...
          <div className="card shadow mb-4">
            <div className="card-body">
              <form id="categoryForm" onSubmit={handleDeleteSubmit}>
                  ...
                  <label htmlFor="categoryName">Xác nhận xóa đánh giá với ID <b>{comment_id || 'không xác định'}</b> ?</label>
                  <input
                    type="text"
