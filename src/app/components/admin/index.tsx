...
<>{ /* Begin Page Content */ }
                <div className="container-fluid">
                    ...
                    <div className="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="#" className="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i className="fas fa-download fa-sm text-white-50" />Xu&#7845;t b&aacute;o c&aacute;o doanh thu</a>
                    </div>
                                    ...
                                    <div className="row no-gutters align-items-center">
                                        <div className="col mr-2">
                                            <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Doanh thu (H&agrave;ng th&aacute;ng)</div>
                                    ...
                                    <div className="row no-gutters align-items-center">
                                        <div className="col mr-2">
                                            <div className="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Doanh thu (H&agrave;ng n&abreve;m)</div>
